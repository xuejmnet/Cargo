...
namespace Cargo.Component.Tools
{
    /// <summary>
    /// 数据连接事务的Session接口
    /// </summary>
    ...
    public class SessionFactory
    {
        ...
        private static IDbConnection CreateConnectionByProvider()
        {
            ...
            string providerName = connStringSetting.ProviderName;
            ...
            switch (providerName)
            {
                ...
                case "MySql.Data.MySqlClient":
                    //=>Mysql
                    //nuget:https://www.nuget.org/packages/MySql.Data/7.0.7-m61
                    conn = new MySqlConnection(connStringSetting.ConnectionString);
                    break;
                case "System.Data.OracleClient":
                case "Oracle.DataAccess.Client":
                    //=>Oracle
                    //nuget:https://www.nuget.org/packages/Oracle.ManagedDataAccess/
                    conn = new OracleConnection(connStringSetting.ConnectionString);
                    break;
                case "System.Data.Odbc"://ODBC Excel Driver
                    conn = new System.Data.OleDb.OleDbConnection(connStringSetting.ConnectionString);
                    break;
            }
            return conn;
        }
